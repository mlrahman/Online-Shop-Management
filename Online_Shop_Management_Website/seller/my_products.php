			...
			<div id="menu_panel">
				<div id="menu_section">
					<ul>
						...
						<li><a href="my_products.php" class="current" title="You are currently in this page.">My Products</a></li>
				...
				<script>
					...
					function suggestion()
					{
						...
						if(search_value!="")
						{
							...
							xmlhttp.open("GET","get_search_suggestion_my.php?search_value="+search_value,true);
							xmlhttp.send();
					...
					function search_exec()
					{
						...
						else
						{
							...
							xmlhttp.open("GET","get_search_product_my.php?search_value="+search_value,true);
							xmlhttp.send();
						}
					}
					...
					function show_products(elem)
					{
						...
						if(elem!="")
						{
							...
							document.getElementById('product_area').innerHTML = '<img src="../images/system/loader.gif" style="margin:50px 0px 0px 275px;" title="Loading...." alt="Loading.." height="300" width="300" />';
							xmlhttp.open("GET","get_category_product_my.php?category_id="+elem,true);
							xmlhttp.send();
						}
					}
				...
				<div id="product_area">
					<?php
						...
						while($data0=mysql_fetch_array($result0))
						{
							...
							$query_c="select * from product where category_id='$data0[category_id]' AND status='active' AND seller_id='$seller_id' order by product_id desc ";
							...
							$query="select * from product where category_id='$data0[category_id]' AND status='active' AND seller_id='$seller_id' order by rank desc ";
