...
if(isset($_GET['product_id']))
	...
	echo '<p id="message" style="display:none;color:white;font-weight:bold;text-align:center;font-size:14px;margin:0 auto;background:red;width:350px;margin-bottom:0px;"> Oops you can\'t buy any product as a seller!!! </p>';
...
?>
	...
	<a href="#" onclick="show_warning()" class="myButton">Buy Now</a>	
