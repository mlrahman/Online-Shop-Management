...
if(isset($_GET['customer_id']))
	{
		...
		$fs="select * from customer_information where username='$username' and customer_id!='$customer_id' ";
		$fr=mysql_query($fs);
		if(mysql_num_rows($fr)==0)
		{
			...
			if($npass=="")
			{
				$us="update customer_information set
					name='$name',
					username='$username',
					email='$email',
					contact='$contact',
		...
		<div class="form-style-10">
			...
			<div class="section">Personal Information<p style="color:red;margin:0px;font-size:12px;display:none;" id="blank_msg"> ** Required feild is mandotory!!! </p>
			<?php
			...
			if(mysql_num_rows($fr)>0)
			{
				...
				echo '<p style="color:red;margin:0px;font-size:12px;display:none;" id="blank_msg"> Username already exists!!! </p>';
			
			}
			if($flag==1)
			{
			
				echo '<p style="color:green;margin:0px;font-size:12px;"> Save changed successfully. </p>';
