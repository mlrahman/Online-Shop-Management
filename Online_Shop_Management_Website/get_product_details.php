...
if(isset($_GET['product_id']))
	...
	echo '<p id="message" style="display:none;color:white;font-weight:bold;text-align:center;font-size:15px;margin:0 auto;background:purple;width:300px;"> Please login for buy any product!!! </p>';
